...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($num == 1) {
        ...
        header("location:/courier/admin/index.php");
    } else {
        $showError = "Invalid.";
    }
}
...
<body class="bg-primary">
    ...
    <div class="container-login text-light ">
        ...
        <form action="/courier/admin/login.php" method="post">
            ...
            <div class="buttons">
                <!-- <p>Don't have a account?</p><a href="/courier/admin/signup.php">Signup Now</a> -->
            </div>
