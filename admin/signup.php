...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $existql = "SELECT * FROM `admin` WHERE username = '$username'";
    ...
    if ($numExistRows > 0) {
        ...
        if (($password == $cpassword)) {
            $sql = "INSERT INTO `admin` (`username`, `password`, `date/time`) VALUES ('$username', '$password', current_timestamp())";
...
<body class="bg-primary">
    ...
    <div class="container-signup text-light">
        ...
        <form action="/courier/admin//signup.php" method="post">
            ...
            <div class="buttons">
                <a href="/courier/admin/login.php">login</a>
            </div>
